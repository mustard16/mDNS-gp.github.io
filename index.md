...
# Exposing Unintended Public mDNS Services at Scale

**Measurement, Vulnerability Analysis, and Abuse Potential**  
...
We propose defenses including **optimized configurations**, **zero-trust access control**, and a **token-based authentication mechanism** for mDNS, validated in real-world Internet experiments.
...
*© 2025 mDNS Security Research Team*
